...
const TranscriptLineAndroid = memo(({
    line,
    isActive,
    onWordClick,
    startIndex,
    ...
    return (
        <p
            ...
            style={{
                ...
                marginBottom: '16px',
                lineHeight: '1.6',
                WebkitTouchCallout: "none", // Prevent native system menus on Android
                userSelect: "none" // Touch interfaces often prefer controlled selection
            }}
        >
            <span
                style={{
                ...
                {line.words.map((w, i) => (
                    <Fragment key={i}>
                        <span
                            ...
                            onClick={() => onWordClick(w.start_ms / 1000)}
                            style={{
                                display: "inline",
                                cursor: "pointer",
                                padding: "2px 2px",
...
export default TranscriptLineAndroid;
